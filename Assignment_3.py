...
# 's' - the part of the element over which to integrate (0 - interior, 1, 2, 3, 4 - sides)
...
# The inputs are:
# 'func' - the integrand with inputs xi, eta, zeta and domain (-1, 1) x (-1, 1) x (-1, 1)
# 's' - part of the element over which to integrate (0 for the interior, 1, 2, 3, 4, 5, 6 for the sides)
