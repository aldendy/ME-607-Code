...
class EnergyDensityTest(unittest.TestCase):
    ...
    def test_getEnDen2D(self):
        ...
        correct = [[1.84551963e+11, 8.88583526e+10],
                   [8.88583526e+10, 1.84551963e+11]]
...
class StiffMatrixAssemblyTest(unittest.TestCase):
    """This class intends to test the stiffness matrix assembly process. These
    tests allow us to conclude that the output matrix is of the appropriate
    size."""
    ...
    def test_1DstiffMat(self):
        ...
        self.assertEqual(len(kmat), len(nodes) - ncons)
    ...
    def test_2DstiffMat(self):
        ...
        self.assertEqual(len(kmat), 2*len(nodes) -
                         ncons)  # checks number of rows
    ...
    def test_3DstiffMat(self):
        ...
        self.assertEqual(len(kmat), 3*len(nodes) -
                         ncons)  # checks number of rows
