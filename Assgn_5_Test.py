...
class ScalingTests(unittest.TestCase):
    ...
    def setUp(self):
        bases = []
        jac0 = []
        xa = [[1, 1, 1], [3, 1, 1], [1, 3, 1], [3, 3, 1], [1, 1, 2],
                      [3, 1, 2], [1, 3, 2], [3, 3, 2]]
    ...
    def test_scaling2D(self):
        self.assertAlmostEqual(scaling(0, self.jac[1]), 1)
    def test_scaling3D(self):
        self.assertAlmostEqual(scaling(0, self.jac[2]), 0.5)
...
class realNTest(unittest.TestCase):
        ...
        def setUp(self):
                bases0 = []
                jac0 = []
                xa = [[1, 1, 1], [2, 1, 1], [1, 2, 1], [2, 2, 1], [1, 1, 2],
                      [2, 1, 2], [1, 2, 2], [2, 2, 2]]
                for i in range(3):  # for every dimension...
                        bases0.append(getBasis(i+1))
