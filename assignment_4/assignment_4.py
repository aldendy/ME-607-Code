...
function returns an array containing evaluations of each basis function and
its derivatives at every integration point."""
...
def getIntPts(numD, d=1.0/3.0**0.5):
        ...
        if numD == 1:
                # array indexed by [point #] where data is [xi value, weight]
...
"""First, we write functions defining the two linear basis functions and their
derivatives for a given dimension. The input is:
...
"""Here, we write functions defining the four linear basis functions and their
derivatives for a given dimension. The input is:
'xi' - independent variable
...
"""This function returns evaluations of the basis functions and their
derivatives in the 2D case over domain (-1, 1) x (-1, 1) and variables 'xi' and
'eta'. The input variables are:
...
"""Here, we write functions defining the eight linear basis functions and their
derivatives for 3D. The input is:
'xi' - independent variable
'eta' - the second independent variable
...
"""This function returns evaluations of the basis functions and their
derivatives in the 3D case over domain (-1, 1) x (-1, 1) x (-1, 1) and
variables 'xi', 'eta' and 'zeta'. The input variables are:
'xi' - the first independent variable
'eta' - the second independent variable
'zeta' - the third independent variable
"""
